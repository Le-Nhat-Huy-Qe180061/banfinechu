        ...
        result.innerHTML =
         `
            ...
            <h1>Summary</h1>
              ...
              <p style="text-align: left;  font-weight: 1000;" >Nếu bạn có nhiều hơn 2 biểu hiện mà chúng tớ đề cập bên trên thì có khả năng là bạn đã bị tổn thương tâm lí, nhưng đừng lo lắng quá chúng mình sẽ giúp cậu chủ động lắng nghe, thấu hiểu và chữa lành những vết thương khi còn mới. Hãy dành ra 3 phút cùng lắng đọng lại để tìm ra gốc rễ của các tổn thương này.  
                <ol style="text-align: left;  font-weight: 800;"> Cậu có thể cân nhắc thêm những lời khuyên sau đây của chúng tớ: 
                    <li>Tìm một nhà tâm lý học hoặc chuyên gia tâm lý để thảo luận về tổn thương và tình trạng tâm lý của cậu nếu nó trở nên nghiêm trọng và gây ra ảnh hưởng lớn tới cuộc sống (https://www.talkspace.com/ )</li>         
                    <li>Tìm một người bạn hoặc người thân mà cậu tin tưởng để thảo luận về những cảm xúc và trạng thái tâm lý của mình, nó sẽ giúp cậu cảm thấy thoải mái hơn đấy </li>  
                    <li>Cậu nhớ dành thời gian và nỗ lực chăm sóc bản thân nhé. Điều này có thể bao gồm việc thực hành yoga, thiền định, tập thể dục, ăn uống lành mạnh, ngủ đủ giấc và tạo ra những hoạt động thú vị cho bản thân á</li>  
                    <li>Học cách quản lý stress tại đây (https://www.helpguide.org/articles/stress/stress-management.htm) có thể giúp bạn giảm căng thẳng và tạo ra cảm giác thư giãn. </li>  
                    <li>Chúng tớ đã xây dựng một nhóm nhỏ để kết nối với những người có trải nghiệm tương tự và giúp cách li các cậu khỏi những thứ độc hại trên MXH. Chia sẻ và lắng nghe những câu chuyện của những người khác có thể mang lại sự hỗ trợ và sự hiểu biết tốt hơn. (https://www.facebook.com/groups/1226531921336932) </li>
                    <li>Cậu còn những cách nào khác hông ?! Chia sẻ thêm với chúng tớ tại group nhé ❤ </li>  
                   Cậu làm tốt lắm, bây giờ cùng chúng tớ giải trí một chút nào ! 
